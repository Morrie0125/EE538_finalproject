...
all: main hpwl_test adjacency_test delta_hpwl_test move_engine_test sa_test delta_consistency_test
...
# T21 — Delta vs full HPWL consistency regression suite
delta_consistency_test: test/tests_delta_consistency.cpp \
                        src/hpwl.cpp \
                        src/adjacency.cpp \
                        src/delta_hpwl.cpp \
                        src/placement.cpp \
                        ...
                        src/writer.cpp
	$(CXX) $(CXXFLAGS) \
	    test/tests_delta_consistency.cpp \
	    src/hpwl.cpp \
	    src/adjacency.cpp \
	    src/delta_hpwl.cpp \
	    src/placement.cpp \
	    src/parser.cpp \
	    src/writer.cpp \
	    -o delta_consistency_test$(EXE_EXT)

# Clean build artifacts
clean:
	-$(RM) main$(EXE_EXT) hpwl_test$(EXE_EXT) adjacency_test$(EXE_EXT) delta_hpwl_test$(EXE_EXT) move_engine_test$(EXE_EXT) sa_test$(EXE_EXT) delta_consistency_test$(EXE_EXT)